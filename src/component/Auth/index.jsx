...
const LoginComp = () => {
  ...
  const checkLogin = (e) => {
    ...
    else if (!loginDetails.userType && !loginDetails?.email !=="" && !loginDetails?.password && captchaInput === "" ){
            ...
            <div className="row flex-grow">
              <div className="col-lg-4 ">
                <div className="auth-form-light text-left p-4">
                  ...
                  >
                     <button className="delete-btn" onClick={()=>handleError()}><Icon path={mdiCloseCircleOutline}  size={1} /></button>
                    {error}
                  </div>
