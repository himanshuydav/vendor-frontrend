...
import SIDEBAR_UL from "./adminmanagesiderbarList";
        ...
        <>
            <div className="menuhead">
                <div className="nav-avater">
                   ...
                   <span className="login-status online">{user?.body[0]?.Name}</span>
                 </div>
            </div>
...
export default AddminManagerSideBar;
