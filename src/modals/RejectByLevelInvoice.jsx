...
const RejectByLevelInvoice = ({ item, handleInvoiceList, levelData }) => {
  ...
  return (
    <div>
      ...
      <p className="text-left mt-2">Are you sure to reject this Bill?</p>
...
export default RejectByLevelInvoice;